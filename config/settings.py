...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-f3gd8*s4*zaozhicbpw#r6rf_bnj$b%v3q9t4w95fc8+s-@@ew')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DJANGO_DEBUG', '') != 'False'

ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,djangogradpro-production.up.railway.app').split(',')
...
DATABASES = {
    "default": dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgresql://postgres:jRaETciQWBgyBRWTYezlyVYdQjhlJcDG@centerbeam.proxy.rlwy.net:30764/railway'),
        conn_max_age=600
    )
}
